...
<html>
  ...
  <head>
    <title> Guest Login | Chill Out Cafe </title>
  </head>
  ...
  <button onclick="topFunction()" id="myBtn" title="Go to top">
   ...
   <br>
   <img style="height:300px;width:320px;" src="images/g1.png" alt="">
        </div>
        <div class="col-sm-6">
        ...
        <div class="container con">
            ...
            <div class="content">
                ...
                <input type="submit" value="Log In" class="subscribe" name="submit">
