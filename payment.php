    ...
    $grand_total=$tax+$gtotal;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <br>
<h1 class="text-center">Grand Total: &#8377;<?php echo "$grand_total"; ?>/-</h1>
...
<h1 class="text-center">
  ...
  <a href="onlinepay.php"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Pay With Card</button></a>
  <button id="rzp-button1" class="btn btn-success">Pay With UPI</button>
  <!-- <a href="razor.php"><button class="btn btn-success" id="rzp-button1"><span class="glyphicon glyphicon-credit-card"></span> Pay With UPI</button></a> -->
